      ...
      <section className="about-me" id="about">
        ...
        <div className="about-text">
          <p>
            ...
            <a href="https://www.offerzen.com/blog/what-civil-engineering-taught-me-about-being-a-good-software-developer" alt="Link to Offerzen blogpost" target="_blank" rel="noopener noreferrer">
              article
            </a>
            {
          ...
          <p> 
            ...
            <a href="https://www.giz.de/en/html/index.html" alt="Link to GIZ website" target="_blank" rel="noopener noreferrer">GIZ</a>
            {" supervised "}
            <a href="https://www.muenchen.de/rathaus/Stadtpolitik/Partnerstaedte/Harare/Staedtische_Projekte/kooperationsprojekt.html" alt="Link to Zigesa project article" target="_blank" rel="noopener noreferrer">
              ZIGESA Trialogue
            </a>
            {" in 2015 which was later extended under "}
            <a href="https://skew.engagement-global.de/funding-from-the-nakopa-programme.html" alt="Link to the Nakopa website" target="_blank" rel="noopener noreferrer">
              Nakopa
            </a>
            {
            ...
            <a href="http://citybyo.co.zw/" alt="Link to the City of Bulawayo website" target="_blank" rel="noopener noreferrer">City of Bulawayo.</a>
          </p>
          <p>
            {
              "Besides software development, engineering and GIS. I am a sketch artist and painter, you can find some of my work on "
            }
            <a href="https://www.deviantart.com/bhekanik" alt="Link to DeviantArt profile" target="_blank" rel="noopener noreferrer">DeviantArt</a>
            {". I am also a co-host of the "}
            <a href="https://anchor.fm/justlivinlife" alt="Link to Just livin' life podcast on Anchor" target="_blank" rel="noopener noreferrer">
              Just Livin' Life podcast
            </a>
            {" and the "}
            <a href="https://www.youtube.com/channel/UCNNaw5_xYuNle7jUU5Y8mmQ" alt="Link to Just livin' life youtube channel" target="_blank" rel="noopener noreferrer">
